...
public class NamespaceRefExpr_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    if (getBuffer().hasPositionsSupport()) {
      TraceInfoGenerationUtil.createPositionInfo(this, node);
    }
    this.append(SPropertyOperations.getString(SLinkOperations.getTarget(node, "nsprovider", false), "name"));
    if (getBuffer().hasPositionsSupport()) {
      {
  ...
  protected static Logger LOG = LogManager.getLogger(NamespaceRefExpr_TextGen.class);
}
