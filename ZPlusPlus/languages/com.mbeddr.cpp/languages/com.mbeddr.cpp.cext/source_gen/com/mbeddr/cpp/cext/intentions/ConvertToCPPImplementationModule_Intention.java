...
public class ConvertToCPPImplementationModule_Intention implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public ConvertToCPPImplementationModule_Intention() {
  }
  ...
  public String getPresentation() {
    return "ConvertToCPPImplementationModule";
  }

  public String getPersistentStateKey() {
    return "com.mbeddr.cpp.cext.intentions.ConvertToCPPImplementationModule_Intention";
  }
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return !(SNodeOperations.isInstanceOf(node, "com.mbeddr.cpp.cext.structure.CppImplementationModule")) && (SNodeOperations.getParent(node) == null);
  }

  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:ab2eb74f-bdf7-4f08-839c-11455dff83d4(com.mbeddr.cpp.cext.intentions)", "4387763778170605340");
  }
  ...
  public Collection<IntentionExecutable> instances(final SNode node, final EditorContext context) {
    if (myCachedExecutable == null) {
      myCachedExecutable = Collections.<IntentionExecutable>singletonList(new ConvertToCPPImplementationModule_Intention.IntentionImplementation());
    }
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SModelOperations.addRootNode(SNodeOperations.getModel(node), cppIm);
    ...
    public IntentionDescriptor getDescriptor() {
      return ConvertToCPPImplementationModule_Intention.this;
    }
  }
}
