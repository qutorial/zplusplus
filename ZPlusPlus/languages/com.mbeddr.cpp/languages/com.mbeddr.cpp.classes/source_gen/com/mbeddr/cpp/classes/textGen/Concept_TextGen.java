...
public class Concept_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.append(" has no C++ representation - deleted.");
    if (getBuffer().hasPositionsSupport()) {
      {
  ...
  protected static Logger LOG = LogManager.getLogger(Concept_TextGen.class);
}
